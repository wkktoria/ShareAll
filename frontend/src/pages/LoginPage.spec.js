...
describe("LoginPage", () => {
  ...
  describe("Interactions", () => {
    ...
    it("sets the password value into state", () => {
      ...
      const passwordInput = queryByPlaceholderText("Your password");
      fireEvent.change(passwordInput, changeEvent("P4@sSw0rd"));
      expect(passwordInput).toHaveValue("P4@sSw0rd");
    });

    it("cals postLogin when the actions are provided in props and input fieldss have value", () => {
      const actions = {
    ...
    it("clears alert when user changes password", async () => {
      ...
      fireEvent.click(button);
      await waitFor(() => queryByText("Login failed"));
      fireEvent.change(passwordInput, changeEvent("updated-P4@sSw0rd"));
